...
# The Basic Two-Step Phenology Model (With September 1st As Dormancy Initiation Date and Parameters: TC = 5, RC = -138, Rh = 280.2)
TC = 5 # threshold temperature below which chill days (Cd) accumulate
Rc = -138 # chill requirement
Rh = 280.2 # heat requirement
