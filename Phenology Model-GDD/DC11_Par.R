...
# PART 1 (result : TC = 5, RC = -140, Rh = 264)
RMSE = 0
Tc = 0
Rc = 0
Rh = 0
...
# PART 2 (result : TC = 5, RC = -135, Rh = 265; MinRMSE = 5.126043)
RMSE = 0
Tc = 0
Rc = 0
Rh = 0
...
for (RH in seq(256,274)){
  for (RC in seq(-120,-135)){
    for (TC in seq(4,7)){
      ppd = 0
      year = 0
      for (i in 1:y){
...
# PART 3 (result : TC = 5, RC = -135.1, Rh = 264.6; MinRMSE = 5.138861)
RMSE = 0
Tc = 0
Rc = 0
Rh = 0
...
for (RH in seq(264.5,265.5,0.1)){
  for (RC in seq(-134.5,-135.5,-0.1)){
