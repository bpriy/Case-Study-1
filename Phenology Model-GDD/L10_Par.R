...
# PART 1 (result : TC = 5, RC = -75, Rh = 205; MinRMSE = 4.594133)
RMSE = 0
Tc = 0
Rc = 0
Rh = 0
...
# PART 2 (result : TC = 5, RC = -68, Rh = 211, MinRMSE = 4.405575)
RMSE = 0
Tc = 0
Rc = 0
Rh = 0
...
# PART 3 (result : TC = 5, RC = -68, Rh = 210.5; MinRMSE = 4.365845)
RMSE = 0
Tc = 0
Rc = 0
Rh = 0
...
for (RH in seq(210,212, 0.1)){
  for (RC in seq(-67,-69,-0.1)){
    for (TC in seq(3,5,0.1)){
      ppd = 0
      year = 0
      for (i in 1:y){
        Cd <- with(datal[[i]], ifelse(0 <= TC & TC <= tmin & tmin <= tmax, 0, 
