...
Rc = -64.1 # chill requirement
Rh = 210.9 # heat requirement
...
for (i in 1:y){ # for each year from 1953 to 2021
  ...
  ppd[i] = totdays - 61 # convert the totdays value to "day of year" (starting from January 1st) & store the "ppd" value obtained in each for-loop iteration (year)
