...
```{r}
## Mean Windspeed (m/s)
plot(kyoto$year, kyoto$mean.wspd, col="blue")
```
...
plot(kyoto$year, kyoto$mean.relative.humidity, col="blue")
```

```{r}
## Mean cloud amount (1/10)
plot(kyoto$year, kyoto$mean.cloud.amount, col="blue")
```

```{r}
## Mean possible sunshine %
plot(kyoto$year, kyoto$mean.percent.possible.sunshine, col="blue")
```

```{r}
## Monthly total sunshine hours
plot(kyoto$year, kyoto$monthly.total.sunshine.hours, col="blue")
```

```{r}
## Monthly total precipitation (mm)
plot(kyoto$year, kyoto$monthly.total.precipitation, col="blue")
```
