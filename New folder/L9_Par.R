...
# PART 1 (result : TC = 5, RC = -75, Rh = 205; MinRMSE = 4.585881)
RMSE = 0
Tc = 0
Rc = 0
Rh = 0
...
# PART 2 (result : TC = 5, RC = -69, Rh = 211; MinRMSE = 4.422737)
RMSE = 0
Tc = 0
Rc = 0
Rh = 0
...
# PART 3 # (result : TC = 5, RC = -69, Rh = 210.5; MinRMSE = 4.395245)
RMSE = 0
Tc = 0
Rc = 0
Rh = 0
...
for (RH in seq(210.5,211, 0.1)){
  for (RC in seq(-69,-70,-0.1)){
